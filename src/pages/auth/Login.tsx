...
const Login = ({
  ...
  return (
    <>
            ...
            <Form {...form}>
              ...
              >
                      ...
                      <FormControl>
                        <div className="relative">
                          <input
                            ...
                            className="h-11 w-full pr-10 sm:pr-12 pl-4 sm:pl-5 text-sm sm:text-base text-gray-200 bg-gray-900/70 border border-gray-700 rounded-sm shadow-inner focus:border-purple-500 focus:ring-0 focus:ring-purple-600 focus:outline-none transition-all"
                          />
                ...
                <Button
                  ...
                  variant="ghost"
                  disabled={loading}
                  className="w-full h-11 bg-gradient-to-r from-purple-500 to-purple-600 rounded-sm text-sm sm:text-base text-white font-semibold transition-all duration-200"
                >
                  {loading ? (
                ...
                <div className="grid grid-cols-2 gap-3 sm:gap-4">
                  <Button
                    type="button"
                    variant="outline"
                    className="h-12 rounded-sm border-border bg-background/50 backdrop-blur-sm hover:bg-primary/5 hover:border-primary/50 transition-all duration-300 group"
                  >
      ...
      {/* Register Modal */}
      <RegisterForm openRegister={registerOpen} onOpenRegisterChange={setRegisterOpen} />
    </>
  );
};
